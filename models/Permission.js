...
const permissionSchema = new mongoose.Schema({
   role: {
    ...
    permissions: {
      ...
      // School Admin specific: Limited school self-management
      canManageOwnSchool: { type: Boolean, default: true },
      ...
      // School Admin: View own payment history
      canViewOwnPayments: { type: Boolean, default: true },
      ...
      canViewAllNotifications: { type: Boolean, default: false },
